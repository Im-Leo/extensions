...
/**
 * The advanced-search form. Its option lists are supplied by the caller because
 * they are derived from the aggregated catalogue rather than published by the
 * site, and every selection is applied locally.
 */
